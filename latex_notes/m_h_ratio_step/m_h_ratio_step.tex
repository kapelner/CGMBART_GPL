...
\beqn
\prob{T} &=& \prod_{\eta \in \Hleaves} \parens{1 - \prob{\text{splitting~} \eta}}  \prod_{\eta \in \Hint} \prob{\text{splitting~} \eta} \prod_{\eta \in \Hint} \prob{\text{assigning a rule to~} \eta} \\
\eeqn
