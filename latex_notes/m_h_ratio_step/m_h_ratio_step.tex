...
\beqn
\cprob{T^*}{T} &=& \prob{\text{GROW}} \oneover{b} \oneover{p_{adj}} \oneover{n_{adj}} \sum_{k=1}^{n_{adj}} \indic{X_{i_k j} = x^*}
\eeqn
...
\beqn
\frac{\prob{T^* \rightarrow T}}{\prob{T \rightarrow T^*}} = \frac{\prob{\text{PRUNE}}\oneover{w_2^*}}{\prob{\text{GROW}}\oneover{b} \oneover{p_{adj}} \oneover{n_{adj}} \sum_{k=1}^{n_{adj}} \indic{X_{i_k j} = x^*}} = \cancelto{?}{\frac{\prob{\text{PRUNE}}}{\prob{\text{GROW}}}} \frac{b ~ p_{adj} ~ n_{adj}}{w_2^* \sum_{k=1}^{n_{adj}} \indic{X_{i_k j} = x^*}}
\eeqn
...
&=& \prob{\text{GROW}} \oneover{b-1} \oneover{p_{adj}} \oneover{n_{adj}} \sum_{k=1}^{n_{adj}} \indic{X_{i_k j} = x^*}
\eeqn
...
\beqn
\frac{\prob{T^* \rightarrow T}}{\prob{T \rightarrow T^*}} = \frac{\prob{\text{GROW}}  \oneover{b-1}\oneover{p_{adj}} \oneover{n_{adj}} \sum_{k=1}^{n_{adj}} \indic{X_{i_k j} = x^*}}{ \prob{\text{PRUNE}}\oneover{w_2}} = \cancelto{?}{\frac{\prob{\text{GROW}}}{\prob{\text{PRUNE}}}} \frac{w_2  \sum_{k=1}^{n_{adj}} \indic{X_{i_k j} = x^*}}{(b-1) p_{adj} n_{adj}}
\eeqn
