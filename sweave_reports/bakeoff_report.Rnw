...
for (model_name in c(real_regression_data_sets, simulated_data_model_names)){
	...
	for (num_trees in num_trees_of_interest){
		...
		for (num_burn_in in num_burn_ins_of_interest){
			...
			for (num_iterations_after_burn_in in num_iterations_after_burn_ins_of_interest){
				...
				image_titles = c("sigsqs", "tree_liks", "tree_nodes", "tree_depths", "yvyhat_bart", "yvyhat_BT_bart", "yvyhat_rf", "yvyhat_cart")
