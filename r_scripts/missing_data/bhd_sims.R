...
mcar_bhd_bartm_results = rbind(oos_rmse_vanilla_bhd, oos_rmse_bhd_bartm_mcar)
rownames(mcar_bhd_bartm_results) = c(0, KnockoutPROP)
mcar_bhd_bartm_results = cbind(mcar_bhd_bartm_results, apply(mcar_bhd_bartm_results, 1, mean))
...
write.csv(mcar_bhd_bartm_results, "mcar_bhd_bartm_results.csv")
...
#mcar_results = cbind(mcar_results, apply(mcar_results, 1, quantile, probs = ALPHA / 2))
#mcar_results = cbind(mcar_results, apply(mcar_results, 1, quantile, probs = (1 - ALPHA) / 2))
write.csv(bhd_lm_results_mcar, "crazy_model_results_lm_mcar.csv")
...
bhd_results_rf_mar = rbind(oos_rmse_vanilla_bhd, oos_rmse_bhd_rf_mar)
rownames(bhd_results_rf_mar) = c(0, KnockoutPROP)
bhd_results_rf_mar = cbind(bhd_results_rf_mar, apply(bhd_results_rf_mar, 1, mean))
write.csv(bhd_results_rf_mar, "bhd_results_rf_mar.csv")
...
points(rownames(bhd_results_bartm), bhd_results_bartm[, Nsim + 1] / bhd_results_bartm[1, Nsim + 1], col = "green", lwd = 3, type = "b")
points(rownames(bhd_results_rf_mar), bhd_results_rf_mar[, Nsim + 1] / bhd_results_bartm[1, Nsim + 1], col = "black", lwd = 3, type = "b")
...
#mar_results = cbind(mar_results, apply(mar_results, 1, quantile, probs = ALPHA / 2))
#mar_results = cbind(mar_results, apply(mar_results, 1, quantile, probs = (1 - ALPHA) / 2))
write.csv(bhd_bartm_results_mar, "mar_bhd_bartm_results.csv")
...
#mar_results = cbind(mar_results, apply(mar_results, 1, quantile, probs = ALPHA / 2))
#mar_results = cbind(mar_results, apply(mar_results, 1, quantile, probs = (1 - ALPHA) / 2))
write.csv(bhd_lm_results_mar, "crazy_model_results_lm_mar.csv")
...
nmar_bhd_bartm_results = rbind(oos_rmse_vanilla_bhd, oos_rmse_bhd_bartm_nmar)
rownames(nmar_bhd_bartm_results) = c(0, KnockoutPROP)
nmar_bhd_bartm_results = cbind(nmar_bhd_bartm_results, apply(nmar_bhd_bartm_results, 1, mean))
...
write.csv(nmar_bhd_bartm_results, "nmar_bhd_bartm_results.csv")
...
crazy_model_results_lm_nmar = rbind(oos_rmse_vanilla_bhd, oos_rmse_bhd_lm_nmar)
rownames(crazy_model_results_lm_nmar) = c(0, KnockoutPROP)
crazy_model_results_lm_nmar = cbind(crazy_model_results_lm_nmar, apply(crazy_model_results_lm_nmar, 1, mean))
#nmar_results = cbind(nmar_results, apply(nmar_results, 1, quantile, probs = ALPHA / 2))
#nmar_results = cbind(nmar_results, apply(nmar_results, 1, quantile, probs = (1 - ALPHA) / 2))
write.csv(crazy_model_results_lm_nmar, "crazy_model_results_lm_nmar.csv")
...
points(rownames(crazy_model_results_lm_nmar), crazy_model_results_lm_nmar[, Nsim + 1] / bhd_results_bartm[1, Nsim + 1], col = "red", lwd = 3, type = "b")
points(rownames(bhd_results_bartm), bhd_results_bartm[, Nsim + 1] / bhd_results_bartm[1, Nsim + 1], col = "green", lwd = 3, type = "b")
