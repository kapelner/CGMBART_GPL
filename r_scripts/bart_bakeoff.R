...
for (simulated_data_model_name in simulated_data_model_names){
	...
	savePlot(paste(PLOTS_DIR, "//", simulated_data_model_name, "_sigsqs_m_", num_trees, "_n_B", num_burn_in, "_n_G_after_", num_iterations_after_burn_in, ".pdf", sep = ""), "pdf")
	plot_tree_liks_convergence_diagnostics(model, extra_text = extra_text)
	savePlot(paste(PLOTS_DIR, "//", simulated_data_model_name, "_treeliks_m_", num_trees, "_n_B", num_burn_in, "_n_G_after_", num_iterations_after_burn_in, ".pdf", sep = ""), "pdf")
	...
	savePlot(paste(PLOTS_DIR, "//", simulated_data_model_name, "_yvyhat_bart_m_", num_trees, "_n_B", num_burn_in, "_n_G_after_", num_iterations_after_burn_in, ".pdf", sep = ""), "pdf")
	...
	savePlot(paste(PLOTS_DIR, "//", simulated_data_model_name, "_yvyhat_rf.pdf", sep = ""), "pdf")
}